<template>
  <div>
    <button
      @click="handleClick"
      class="bg-[#115C5E] text-white px-4 py-2 rounded hover:bg-[#187879] transition"
    >
      아파트 요약 보기
    </button>
  </div>
