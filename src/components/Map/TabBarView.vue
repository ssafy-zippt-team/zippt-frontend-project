<template>
  <div class="tab-panel">
    ...
    <div
      ...
      @mouseleave="stopDrag"
    >
      <ul class="flex justify-around text-sm min-w-max">
        <li
    ...
    <div class="content">
      ...
      <AptReviewPanel v-else-if="selectedTab === 'review'" :apt-seq="aptSeq" />
      <!-- 리뷰 탭 -->
      <CommercialChartPanel v-else-if="selectedTab === 'CommercialChartPanel'" :selected-coords="selectedCoords" />
      <!-- 리뷰 탭 -->
    </div>
  </div>
</template>
